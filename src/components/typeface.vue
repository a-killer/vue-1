    ...
    run() {
      ...
      vertex3d.prototype = {
        ...
        var	sphere = function(arg) {
          ...
          for(var i in chars) {
            var bufferEl = document.getElementById(i);
            if(bufferEl.tagName == "CANVAS") {
              var buffer = bufferEl.getContext("2d").getImageData(0, 0, 100, 100).data;
        ...
        var textSet = [
          {text:"ISMAIL", sphereRadius:140, sphereSpace:80, unitTime:100, time:5000},
          {text:"ANGELO", sphereRadius:120, sphereSpace:70, unitTime:120, time:5000},
